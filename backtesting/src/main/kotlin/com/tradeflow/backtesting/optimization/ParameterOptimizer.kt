...
class ParameterOptimizer {
    ...
    private fun printChampionParameters(champion: StrategyConfig) {
        ...
        println("  rangeEntryMultiplier:        ${champion.rangeEntryMultiplier.default}")
        println("  rangeStopMultiplier:         ${champion.rangeStopMultiplier.default}")
        println("  rangeRsiMidpoint:            ${champion.rangeRsiMidpoint.default}")
        println("  smaPeriod:                   ${champion.smaPeriod.default.toInt()}")
        println("  adxPeriod:                   ${champion.adxPeriod.default.toInt()}")
        println("  atrPeriod:                   ${champion.atrPeriod.default.toInt()}")
        println("  rsiPeriod:                   ${champion.rsiPeriod.default.toInt()}")
        println("  volumeSmaPeriod:             ${champion.volumeSmaPeriod.default.toInt()}")
        println("  minVolumeRatio:              ${champion.minVolumeRatio.default}")
        println("  rsiLongBlockThreshold:       ${champion.rsiLongBlockThreshold.default}")
        println("  rsiShortBlockThreshold:      ${champion.rsiShortBlockThreshold.default}")
        println("  smaPreviousLookback:         ${champion.smaPreviousLookback.default.toInt()}")
        println()
    }
